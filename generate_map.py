...
RAW_ADDRESS_MAP = {
    ...
    '\u2020Kv\u2021Zvqvjx, gqgbwmsn':  ("কোতোয়ালী", "ময়মনসিংহ"),
...
LOCATION_COORDS = {
    # Mymensingh District
    ("সদর", "ময়মনসিংহ"): (24.7471, 90.4203),
    ("গফরগাঁও", "ময়মনসিংহ"): (24.4326, 90.5587),
    ("ত্রিশাল", "ময়মনসিংহ"): (24.5744, 90.3953),
    ("ঈশ্বরগঞ্জ", "ময়মনসিংহ"): (24.6278, 90.6861),
    ("তারাকান্দা", "ময়মনসিংহ"): (24.8364, 90.3683),
    ("মুক্তাগাছা", "ময়মনসিংহ"): (24.7614, 90.2568),
    ("ফুলপুর", "ময়মনসিংহ"): (24.9333, 90.3333),
    ("গৌরীপুর", "ময়মনসিংহ"): (24.7500, 90.5000),
    ("নান্দাইল", "ময়মনসিংহ"): (24.5667, 90.7000),
    ("ভালুকা", "ময়মনসিংহ"): (24.3750, 90.3778),
    ("ফুলবাড়ীয়া", "ময়মনসিংহ"): (24.5500, 90.2333),
    ("হালুয়াঘাট", "ময়মনসিংহ"): (25.0667, 90.2833),
    ("ধোবাউড়া", "ময়মনসিংহ"): (25.0833, 90.0500),
    ("কোতোয়ালী", "ময়মনসিংহ"): (24.7471, 90.4203),

    # Netrokona District
    ("সদর", "নেত্রকোনা"): (24.8817, 90.7289),
    ("পূর্বধলা", "নেত্রকোনা"): (24.5167, 90.8167),
    ("আটপাড়া", "নেত্রকোনা"): (24.6500, 90.7833),
    ("খালিয়াজুড়ী", "নেত্রকোনা"): (24.9167, 91.0833),
    ("কেন্দুয়া", "নেত্রকোনা"): (24.6500, 90.8333),
    ("দুর্গাপুর", "নেত্রকোনা"): (25.1167, 90.6833),
    ("মোহনগঞ্জ", "নেত্রকোনা"): (24.8833, 90.8500),
    ("মদন", "নেত্রকোনা"): (24.8833, 90.9833),
    ("বারহাট্টা", "নেত্রকোনা"): (24.8333, 90.7500),

    # Jamalpur District
    ("সদর", "জামালপুর"): (24.9333, 89.9500),
    ("মাদারগঞ্জ", "জামালপুর"): (25.0167, 89.7500),
    ("ইসলামপুর", "জামালপুর"): (25.1333, 89.6500),
    ("বকশিগঞ্জ", "জামালপুর"): (25.1833, 90.1000),

    # Sherpur District
    ("সদর", "শেরপুর"): (25.0189, 90.0144),
    ("নকলা", "শেরপুর"): (24.9667, 90.0500),

    # Kishoreganj District
    ("সদর", "কিশোরগঞ্জ"): (24.4333, 90.7833),
    ("তাড়াইল", "কিশোরগঞ্জ"): (24.4000, 90.8833),
    ("কটিয়াদী", "কিশোরগঞ্জ"): (24.4167, 90.8333),
    ("কুলিয়ার চর", "কিশোরগঞ্জ"): (24.5000, 90.8667),
    ("নকলা", "কিশোরগঞ্জ"): (24.4000, 90.5500),

    # Tangail District
    ("সদর", "টাঙ্গাইল"): (24.2647, 89.9164),
    ("সখিপুর", "টাঙ্গাইল"): (24.3167, 90.1667),
    ("মির্জাপুর", "টাঙ্গাইল"): (24.1000, 90.1000),
    ("গোপালপুর", "টাঙ্গাইল"): (24.5667, 89.9167),
    ("ঘাটাইল", "টাঙ্গাইল"): (24.3833, 90.0000),

    # Other districts
    ("সদর", "গোপালগঞ্জ"): (23.0167, 89.8167),
    ("নবাবগঞ্জ", "ঢাকা"): (23.6167, 90.2167),
    ("বেলাব", "নরসিংদী"): (24.0833, 90.8667),
    ("সদর", "মানিকগঞ্জ"): (23.8667, 90.0333),
    ("কসবা", "ব্রাহ্মণবাড়ীয়া"): (23.6333, 91.1500),
    ("সদর", "ঠাকুরগাঁও"): (26.0333, 88.4667),
    ("সদর", "বরিশাল"): (22.7000, 90.3667),
    ("সোনাইমুড়ী", "নোয়াখালী"): (22.9833, 91.0833),
    ("কচুয়া", "চাঁদপুর"): (23.3167, 90.6833),
    ("সদর", "বিনাইদহ"): (23.5500, 89.1667),
}
